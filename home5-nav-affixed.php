       ...
       <div class="container-full">
        ...
        data-anchor-target="#full-width-slider">
            ...
            <section id="industrys-choice-2" class="light-bg">
                ...
                <div class="container inner-bottom-sm inner-left-md inner-right-md" style="padding-top: 50px;">
                    <div class="row">
                        <div class="col-md-10 col-sm-9 center-block text-center">


                            <h4 style="padding-bottom: 20px;">You’ll be on the path to an exciting future when you enroll in a training program at one of these highly respected tech schools:</h4>
                            <div class="row" style="padding-top:10px;">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xxs-12">
                                    <a href="/programs"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-uti.ashx"></a>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xxs-12">
                                    <a href="/programs/nascar"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-nti.ashx"></a>
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <ul class="fa-ul inner-left-sm">
                            ...
                            <div class="row" style="padding-top:10px;">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xxs-12">
                                    <a href="/programs/motorcycle"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-motorcycle.ashx"></a>
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <ul class="fa-ul inner-left-sm">
                            ...
                            <div class="row" style="padding-top:10px;">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xxs-12">
                                    <a href="/programs/marine"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-marine.ashx"></a>
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <ul class="fa-ul inner-left-sm">
