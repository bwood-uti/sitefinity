...
<html lang="en">
    <head>
        ...
        <title>Home v2 - Universal Technical Institute</title>
    ...
    <body>
       ...
       <div class="container-full">
        ...
        <main>
            ...
            <section>
                ...
                <div class="container inner-top-xs inner-left-md inner-right-md">
                    <div class="row">
                        <div class="col-md-11 col-sm-10 center-block text-center">

                            <h1 class="no-bottom-margin">UNIVERSAL TECHNICAL INSTITUTE (UTI)</h1>
                            <h4 class="no-top-margin">Technician training school for the transportation industry</h4>
                ...
                <div class="container inner-top-sm inner-bottom-xs">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-10 center-block text-center">
                            <header>
                                <h3 class="large no-bottom-margin">WHY CHOOSE UTI?</h3>
                                <h4>Because the industry does.</h4>
            ...
            <section id="industrys-choice" class="light-bg">
                <div class="container-fluid inner-top-sm inner-bottom-sm inner-left inner-right">

                    <div class="row">
	                    <div class="col-md-12 col-sm-9">
		                    <h3 class="large">INDUSTRY’S CHOICE FOR TRAINED TECHNICIANS</h3>
		                </div>
                        ...
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="row" style="padding-top:10px;">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-xxs-12">
                                    ...
                                    <a href="/programs"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-uti.ashx"></a><br>
                                    <span class="bold">Universal Technical Institute</span> <br>
                                    <span style="font-weight:300;">Automotive Technology, Diesel Technology, Collision Repair Technology</span>
                                    
                                </div>
                                
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-xxs-12">
                                    
                                    <a href="/programs/nascar"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-nti.ashx"></a><br>
                                    <span class="bold">NASCAR Technical Institute</span> <br>
                                    <span style="font-weight:300;">Motorsports Technology</span>
                                </div>
                            </div>
                            ...
                            <div class="row" style="padding-top:20px;">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-xxs-12">
                                    ...
                                    <a href="/programs/motorcycle"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-motorcycle.ashx"></a><br>
                                    <span class="bold" style="padding-top:7px;">Motorcycle Mechanics Institute </span> <br>
                                    <span style="font-weight:300;">Motorcycle Technology</span>
                                    
                                </div>
                                
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-xxs-12">
                                    
                                    <a href="/programs/marine"><img src="http://sitecorestage.uti.edu/~/media/Images/UTI/Logos/Content/logo-content-marine.ashx"></a><br>
                                    <span class="bold" style="padding-top:7px;">Marine Mechanics Institute</span> <br>
                                    <span style="font-weight:300;">Marine Technology</span>
                                </div>
                            </div>
       ...
       </div><!-- end of 1400px max-width container -->
    </body>
